...
function DetalleDestino() {
  ...
  if (loading) {
    return <div className="p-8 text-center text-gray-500">Cargando destino...</div>;
  }
  ...
  return (
    <div className="p-8 max-w-2xl mx-auto">
      <Link to="/" className="text-blue-500 hover:underline text-sm mb-4 inline-block">
        ← Volver al inicio
      </Link>
      ...
      {destino.precioPorNoche && (
        <p className="text-green-600 font-bold text-xl mb-4">${destino.precioPorNoche} / noche</p>
      )}
